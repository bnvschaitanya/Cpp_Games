//A simple car racing in c++ using console
#include<iostream>  
#include<conio.h>  
#include<dos.h>   
#include <windows.h>  
...
The srand() function, which is part of the C++ STL, is used to initialise the random number generator by setting a seed value. 
